...
T_first=Tg_exp[0]		#Picking last experimental value
P_first=Pg_exp[0]		#Picking last experimental value
dTg_dP_atm=(T_last-T_first)/(P_last-P_first)
...
P_line = npy.linspace(0.101325,P_last,6)
...
Rratio_min=1.48838713
epsilon_2_min=4626.48878181
x_min=0.32
...
###    Tg VERSUS P Plots  #### 
###################################################################################
plt.plot(P,Tg_calculated,'k',color='g',lw=linewidth,ls='-',label='Theoretical Curve')
